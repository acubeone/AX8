...
MODULES += toplevel cpu instruction_sequencer interrupt_sequencer
...
MODULES += decode_system decode_memory decode_arithmetic decode_unary decode_jump instruction_decoder
