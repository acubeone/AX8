...
- [Wikipédia - Instruction Cycle](https://en.wikipedia.org/wiki/Instruction_cycle)
- [Wikipédia - Addressing Mode](https://en.wikipedia.org/wiki/Addressing_mode)
- [Wikipédia - Orthogonal Instruction Set](https://en.wikipedia.org/wiki/Orthogonal_instruction_set)
